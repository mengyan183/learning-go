...
func easyjson8da0e4fcDecodeJson(in *jlexer.Lexer, out *JobInfo) {
...
func easyjson8da0e4fcEncodeJson(out *jwriter.Writer, in JobInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v JobInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8da0e4fcEncodeJson(&w, v)
...
func (v *JobInfo) UnmarshalJSON(data []byte) error {
	...
	easyjson8da0e4fcDecodeJson(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *JobInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8da0e4fcDecodeJson(l, v)
}
func easyjson8da0e4fcDecodeJson1(in *jlexer.Lexer, out *Employee) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8da0e4fcEncodeJson1(out *jwriter.Writer, in Employee) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Employee) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8da0e4fcEncodeJson1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Employee) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8da0e4fcDecodeJson1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Employee) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8da0e4fcDecodeJson1(l, v)
}
func easyjson8da0e4fcDecodeJson2(in *jlexer.Lexer, out *BasicInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8da0e4fcEncodeJson2(out *jwriter.Writer, in BasicInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v BasicInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8da0e4fcEncodeJson2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *BasicInfo) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8da0e4fcDecodeJson2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *BasicInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8da0e4fcDecodeJson2(l, v)
}
